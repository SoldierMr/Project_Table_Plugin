 ...
 */
//tr的html
var trHTML = '<tr class="_qd_trSize"></tr>';
//th复选框和序号的html
var thSelectIdHTML = '<th class="_qd_headColumn" name="dataAllSelect"><div class="_qd_checkBoxDiv"><input class="_qd_checkBox" type="checkbox"></div></th><th class="_qd_headColumn" name="dataItemIdName">序号</th>';
//th的html
var thHTML = '<th class="_qd_thSize" name="dataAttr" attrname="" showtip="false"></th>';
//table隐藏属性名称的html
// const thHideDivHTML = '<div class="_global_displayNone" name="dataAttr"></div>';
//td复选框和序号id的html;
var tdSelectIdHTML = '<td class="_qd_headColumn" name="dataItemSelect"><div class="_qd_checkBoxDiv"><input class="_qd_checkBox" type="checkbox"></div></td><td class="_qd_headColumn" name="dataItemId"></td>';
//td的html;
...
var tdHTML = '<td class="_qd_tdSize" name="dataValue" attrname="" qdeditable="false" showtip="false"></td>';
...
//存储复合数据
var compoundData = void 0;
//存储分割字符串长度标准
var cutNum = 100;

//存储表格循序
var tableColumnOrder = void 0;
//存储自定义表头中每列的宽度
var columnWidthArr = [];
...
function SortMethod(methodNameArr) {
    ...
    for (var _index2 in arguments) {
        if (!isNaN(_index2)) {
            arguments[_index2] = null;
        }
    }
}
...
function handleDataConfig(compoundData) {
    ...
    var methodNameArr = void 0;
    var innerHTML = void 0;
    var itemStrArr = void 0;
    var _data = void 0;
...
function rewriteTableThHTML(htmlStr, dataSource) {
    if ((typeof dataSource === 'undefined' ? 'undefined' : _typeof(dataSource)) != "object") {
        throw new Error('修改table的th名称函数传入的参数需为object/Array');
    }
    if (htmlStr.indexOf('</th>') < 0) {
        return htmlStr;
    }
    var returnHtmlStr = htmlStr;
    var thRule = /<th[^>]+dataAttr[^>]+>((?!<th).)+<\/th>/g;
    var attrName = void 0;
    var shortTimeSave = void 0;
    var index = void 0;
    ...
    for (var _index3 in arguments) {
        if (!isNaN(_index3)) {
            arguments[_index3] = null;
        }
    }
...
function setTableLineHeightHTML(htmlStr, heightValue) {
    ...
    var trRule = /<tr[^>]*>/g;
    var styleRule = /style=('|")[^'"]+('|")/;
    var heightRule = /height:[^;]+;?/;
    var tdRule = /<td[^>]+dataValue[^>]+>((?!<\/td>).)*<\/td>/g;
    var editBoxRule = /<div[^>]+editBox[^>]+>/;
    //存储heightValue的数值
    var trueLineHeight = void 0;
    var returnTrStr = void 0;
    var returnStyleStr = void 0;
    var returnTdStr = void 0;
    var returnBoxStr = void 0;
...
function showColumn(htmlStr, attrNameArr) {
    var returnHtmlStr = htmlStr;
    var thRule = /<th[^>]+dataAttr[^>]*>((?!<\/th>).)*<\/th>/g;
    var tdRule = /<td[^>]+attrname[^>]+>/g;
    var classRule = /class=('|")[^'"]+('|")/;
    var nodeAttrName = void 0;
    var returnThStr = void 0;
    var returnTdStr = void 0;
    var returnClassStr = void 0;
    //暂时存储
    var shortTimeSave = void 0;
    ...
    if (attrNameArr != 'all') {
        returnHtmlStr = returnHtmlStr.replace(thRule, function (thStr) {
            ...
            if (inArray(nodeAttrName, attrNameArr) == -1) {
                //隐藏
...
function rewriteLabelToTdHTML(htmlStr, rewriteDataObj) {
    var returnHtmlStr = htmlStr;
    var attrName = rewriteDataObj.attrName;
    var tdRule = /<td[^>]+dataValue+[^>]+>((?!<\/td>).)*<\/td>/g;
    var tdHeadRule = /<td[^>]+dataValue+[^>]+>/;
    var attrNameRule = /attrname=('|")[^'"]+('|")/;
    var tdHead = void 0;
    var labelAttrName = void 0;
    var returnTdStr = void 0;
...
function setEditColumn(htmlStr, editNameArr) {
    var tdRule = /<td((?!<\/td>).)+<\/td>/g;
    var attrNameRule = /attrname=('|")[^'"]*('|")/;
    var tdHeadLabelRule = /<td[^>]+>/;
    var editAbleRule = /qdeditable=('|")[^'"]+('|")/;
    var attrName = void 0;
    var returnTdStr = void 0;
    var returnHLStr = void 0;
...
//创建table标题：th
function create_th() {
    var tableTitleTrHTML = trHTML;
    var selectIdHTML = thSelectIdHTML;
    // let trueData = (data instanceof Array) ? data[0] : data;
    var otherItemHTML = thHTML;
    var returnInnerHtml = void 0;
...
function create_td(data, index) {
    var tableContentTrHTML = void 0;
    var selectIdHTML = tdSelectIdHTML;
    var otherItemHTML = tdHTML;
